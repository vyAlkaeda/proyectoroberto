...
fun determinarEdades(sintoma: String): List<String> {
    return when {
        ...
        // Síntomas digestivos específicos del hígado/páncreas
        sintoma.contains("HEPATITIS") ||
        sintoma.contains("NECROSIS HEPATICA") ||
        sintoma.contains("HEMORRAGIA HEPATICA") ||
        sintoma.contains("MANCHAS") && sintoma.contains("LECHE") && sintoma.contains("HIGADO") ||
        sintoma.contains("LESIONES") && sintoma.contains("HIGADO") ||
        sintoma.contains("PANCREATITIS") ||
        sintoma.contains("NECROSIS PANCREATICA") ||
        sintoma.contains("VESICULA BILIAR") ||
        sintoma.contains("INFARTO") && sintoma.contains("VESICULA") -> 
            listOf("Lechones destetados (22-56 días)", "Crecimiento/Engorda (57 días a mercado)", "Adultos/Reproductores")
        
        // Síntomas específicos de micotoxinas
        sintoma.contains("AFLATOXINA") ||
        sintoma.contains("OCRATOXINA") ||
        sintoma.contains("TRICOTECENOS") ||
        sintoma.contains("FUMONISINA") ||
        sintoma.contains("ZEARALENONA") -> 
            listOf("Todas las edades")
        
        // Síntomas específicos de parásitos
        sintoma.contains("ASCARIS") ||
        sintoma.contains("ESTRONGILOIDES") ||
        sintoma.contains("COCCIDIOSIS") ||
        sintoma.contains("CAMPILOBACTERIOSIS") -> 
            listOf("Lechones destetados (22-56 días)", "Crecimiento/Engorda (57 días a mercado)")
        
        // Síntomas específicos de enfermedades bacterianas
        sintoma.contains("ESTREPTOCOCOSIS") ||
        sintoma.contains("PLEURONEUMONIA") ||
        sintoma.contains("PRRS") ||
        sintoma.contains("BRUCELOSIS") ||
        sintoma.contains("ERISIPELA") ||
        sintoma.contains("CLOSTRIDIOSIS") ||
        sintoma.contains("SALMONELOSIS") ||
        sintoma.contains("CIRCOVIRUS") -> 
            listOf("Todas las edades")
